 ...
 */
@Entity
public class CategorieConsommation implements Serializable {
    ...
    private TypeConsommation typeConsommation;
     @OneToOne(mappedBy = "categorieConsommation")
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CategorieConsommation)) {
            return false;
        }
        CategorieConsommation other = (CategorieConsommation) object;
    ...
    public String toString() {
        return "com.poussin.consommationv1.bean.CategorieConsommation[ id=" + id + " ]";
    }
